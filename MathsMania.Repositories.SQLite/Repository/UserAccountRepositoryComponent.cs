namespace MathsMania.Repositories.SQLite
{
	...
	{
		public UserAccountRepositoryComponent(DatabaseAgent databaseAgent, MathsManiaSqlStatements sqlStatements)
		{
		...
		private MathsManiaSqlStatements SqlStatements { get; set; }
	}
}